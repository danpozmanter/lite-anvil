...
local function register_mouse_pressed(self)
  ...
  function RootView:on_mouse_pressed(button, x, y, clicks)
    if not this:on_mouse_pressed(button, x, y, clicks) then
...
local function unregister_mouse_pressed(self)
  local RootView = require "core.rootview"
  if self.on_mouse_pressed_root and self.new_on_mouse_pressed_root == RootView.on_mouse_pressed then
...
function NagView:get_message_height()
  local h = 0
  for _ in string.gmatch(self.message, "(.-)\n") do
